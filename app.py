...
from flask_bcrypt import Bcryptimport json
import csv
import io
import os
import requests
...
"""
        ...
        if total_weight == 0:
            ...
            for cat in selected_categories:
                if cat in needs:
                    ...
                    # Other categories get distributed among remaining
    ...
    # Fix rounding issues (ensure sum is exactly 100)
    total = sum(allocation.values())
...
def upsert_budget(user_id):
    ...
    if existing:
        ...
        existing = Budget(user_id=user_id, category=category, limit_amount=limit)import json
import csv
import io
import os
import requests
