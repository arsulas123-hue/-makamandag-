...
... [rest of styles unchanged, omitted for brevity but included in actual file] ...
</style>
</head>
<body>
<nav class="sidebar">
...
// ... (rest of JS unchanged, including renderStats, addFeedEvent, AI plan, OCR, history, insights, admin, etc.) ...
</script>
</body>
</html>
"""
