...
# ----------------------------------------------------------------------
# ML / Prediction helpers (keep your existing implementations)
# ----------------------------------------------------------------------
# ... (all compute_health_score, generate_weekly_forecast, etc.)
# For brevity, copy them from your previous working file.
# I'll include them fully in the final answer but they are unchanged.
# ----------------------------------------------------------------------

# ----------------------------------------------------------------------
# Routes – all your existing endpoints go here (register, login, etc.)
# ----------------------------------------------------------------------
@app.route('/')
def index():
    return HTML_PAGE

# ... (all your API routes, exactly as you had them in the last working version)
...
# ----------------------------------------------------------------------
# Embedded HTML (frontend) – paste your full HTML here
# ----------------------------------------------------------------------
<!DOCTYPE html>
<html lang="en">
<head>
