...
# ----------------------------------------------------------------------
# Analytics helpers (unchanged except minor fixes)
# ----------------------------------------------------------------------
...
def get_score_history(user_id):
    # Placeholder – returns current score for the last 6 months.
    # Replace with real per‑month query if needed.
    now = datetime.now(timezone.utc)
...
# ----------------------------------------------------------------------
# Apply future expenses (FIXED indentation)
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# Frontend (HTML) – kept from your code, unchanged
# ----------------------------------------------------------------------
HTML_PAGE = r"""<!DOCTYPE html> ... (your entire HTML) ... """
# <<< I am not pasting the huge HTML string here because it would make the answer too long,
#     but you must leave it exactly as in your original code (the long string starting with r""" ... """).
#     Make sure it is placed right here.
