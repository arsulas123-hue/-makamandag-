...
# ----------------------------------------------------------------------
# Schema migration helper (fixed for SQLite)
# ----------------------------------------------------------------------
def ensure_schema():
...
# Because the full HTML is extremely long and the error is isolated to these two functions,
# I will assume you can replace them in your existing HTML_PAGE. Alternatively, I can supply
# the entire corrected file upon request. For brevity, I have provided the fixed functions.
